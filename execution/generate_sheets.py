...
target_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), ".tmp")
...
sample_data = [
    ...
    ["2026-07-24 07:42:00", "Siti Nurhaliza", "2026-07-24", "07:42", "Hadir", "Sosialisasi UMKM", "foto_siti_20260724.jpg"],
    ["2026-07-24 08:00:10", "Budi Santoso", "2026-07-24", "08:00", "Izin", "Acara Keluarga KKN", "surat_budi.pdf"],
    ["2026-07-24 08:15:30", "Dewi Lestari", "2026-07-24", "08:15", "Hadir", "Mengajar di SD 01", "foto_dewi_20260724.jpg"],
    ["2026-07-24 08:30:00", "Rian Pratama", "2026-07-24", "08:30", "Sakit", "Demam / Istirahat Posko", "surat_dokter_rian.jpg"],
]
...
for r_idx, row_data in enumerate(sample_data, start=start_row):
    ...
    for c_idx, val in enumerate(row_data, start=1):
        ...
        # Alignment & Number format per column
        if c_idx in [1, 3, 4, 5]:  # Timestamp, Tanggal, Waktu, Status
            cell.alignment = Alignment(horizontal="center", vertical="center")
        else:
            cell.alignment = Alignment(horizontal="left", vertical="center")

# Prepare empty rows up to row 50 for future entries with validation & formatting
